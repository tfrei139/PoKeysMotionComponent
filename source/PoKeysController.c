/* Autogenerated by /usr/bin/halcompile on Sat Nov 22 21:07:38 2025 -- do not edit */
#include "rtapi.h"
#ifdef RTAPI
#include "rtapi_app.h"
#endif
...
#line 36 "source/PoKeysController.comp"
...
bool ConnectPokeysDevice(struct ComponentStruct* componentInstance) {
    ...
    switch (_device->DeviceData.DeviceType)
    {
...
void ProcessPositions(struct ComponentStruct* componentInstance) {
    for (int i = 0; i < NumberOfAxis; i++) {
        ...
        *componentInstance->axis_home[i] = (_device->PEv2.HomeStatus >> i) & 0x01;
...
// ------------------------------------
void SetActiveOutputsOff() {
    if (_device->PEv2.ExternalOCOutputs > 0) {
